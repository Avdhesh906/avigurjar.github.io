...
function update_check(sq_version){
	...
	$.ajax({
		...
		success: function(data){
			...
			var msg="<div class='alert alert-success'>You are using updated version of <a href='https://amitycse.eu.org'>Amiworld Quiz "+sq_version+"</a></div>";
			}else{
			var msg="<div class='alert alert-danger'>New version available: Savsoft Quiz v"+data.trim()+". You are using outdated version of Amiworld Quiz v"+sq_version+". Visit <a href='https://amitycse.eu.org'>amitycse.eu.org</a> to download</div>";
